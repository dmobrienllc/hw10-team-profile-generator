...
describe("Intern", () => {
    describe("Initialization", () => {
        it("should create an Intern object with 'id' number, 'name' string,'email' string, 'iconPath' string, 'school' string", () => {
            //Arrange
            const intern = new Intern(1, "David OBrien", "dmobrienllc@gmail.com", "icon.src", "MIT");

            //Assert
            expect(intern).toEqual({ id: 1, name: "David OBrien", email: "dmobrienllc@gmail.com", iconPath: "icon.src", school: "MIT" });
        });
    });
    ...
    describe("getID", () => {
        it("should return the number '5' from the super class", () => {
            //arrange
            const intern = new Intern(5, "David OBrien", "dmobrienllc@gmail.com", "icon.src", "MIT");
